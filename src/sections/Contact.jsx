  ...
  return (
    ...
    <>
      <div className={`${darkMode ? "dark: bg-black" : "light bg-transparent"} pb-20`}>
        <section id="contact" className={`${darkMode ? "dark: bg-gray-800" : "light bg-red-100"} lg:w-[95%] w-full m-auto rounded-xl grid lg:grid-cols-2 grid-cols-1 justify-center
